...
/**
  ...
  *
  * @param getPublicInstance get public instance which is accessible via refs
  * @param getRootHostContext hostContext for the root node
  * @param getChildHostContext derive host context for a child node given parent host context and parentType
  * @param prepareForCommit Prepare the root container for the commit phase. Happens once per a commit phase?
  */
[@bs.obj]
